...
public class MostarInformes extends javax.swing.JFrame {

    public MostarInformes() throws SQLException {
        initComponents();
        mostar();
        this.setLocationRelativeTo(null);
    }

    public void mostar() throws SQLException {
        DefaultTableModel tb = new DefaultTableModel();
        tb.addColumn("Id");
        tb.addColumn("Nombre");
        tb.addColumn("Apellido");
        tb.addColumn("Residencia");
        tabla.setModel(tb);
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        try {
            MostarInformes_2 ver = new MostarInformes_2();
            ver.setVisible(true);
            this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            MostarInformes_3 ver = new MostarInformes_3();
            ver.setVisible(true);
            this.dispose();
        } catch (SQLException ex) {
            Logger.getLogger(MostarInformes.class.getName()).log(Level.SEVERE, null, ex);
