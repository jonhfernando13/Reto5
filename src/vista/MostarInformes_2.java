...
public class MostarInformes_2 extends javax.swing.JFrame {

    public MostarInformes_2() throws SQLException {
        initComponents();
        mostar2();
        this.setLocationRelativeTo(null);
    }

    public void mostar2() throws SQLException {
        DefaultTableModel tb = new DefaultTableModel();
        tb.addColumn("Id");
        tb.addColumn("Constructora");
        tb.addColumn("Habitaciones");
        tb.addColumn("Ciudad");
        tabla.setModel(tb);
